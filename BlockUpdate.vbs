...
Dim filename        : filename            = "BlockedUpdateList.txt"
...
Dim MSG_HIDE_UPDATES_INFO : MSG_HIDE_UPDATES_INFO = "HIDE THE UPDATES!" & vbNewLine &_
													"Hidden Updates won't reappear in the future, unless restored."
...
' Cycles through Updates (found by <PerformUpdateCheck>).
